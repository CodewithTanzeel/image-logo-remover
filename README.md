# rmlogo - Watermark & Logo Remover

A fast, easy-to-use CLI tool to remove watermarks and logos from images. **One command, instant results** — no GPU, no AI models, no complicated setup.

[![PyPI version](https://img.shields.io/pypi/v/rmlogo.svg)](https://pypi.org/project/rmlogo/)
...
That's it! Your cleaned image is saved as `cleaned.jpg`.
...
```bash
rmlogo --batch ./photos/
# Output: ./cleaned_images_20250307_154230/
```
